...
def test_adr_in_group(app):
    if app.addline.count()==0 and app.group.count()==0:
        app.group.create(Group(name="Test"))
        app.addline.add_new(Addrress(fname="test 3", mname="test 3", lname="test 3", niname="test 3", comp="test 3", addrr="test 3", homtel="+7777444test3", mail="3ehgsl@test"))
